...
def run_mineru(pdf_path: str | Path | list[str | Path] | tuple[str | Path, ...]) -> None:
    """
    Запускает MinerU для одного PDF-файла, папки с PDF или списка PDF-файлов.

    Используется сбалансированный режим:
    - method=auto;
    ...
    Такой режим лучше стандартного запуска, но не должен работать слишком долго.
